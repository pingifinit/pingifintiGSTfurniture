<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
						  <form action="<?php echo base_url();?>index.php/Admin/Edit_Category_Expenses_Data/<?php echo $tablename; ?>/<?php echo $id; ?>" method="post">
                            <?php $profile = $this->Admin_model->table_column($tablename="expense_category", $column="id", $val=$id);
								if (count($profile) > 0) 
								{ 
							...
							<div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="category_name" value="<?php echo $row['category_name']; ?>" name="category_name" placeholder="Enter Category Name Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Sub Category Name</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="sub_name" value="<?php echo $row['sub_name']; ?>" name="sub_name" placeholder="Enter Sub Category Here">
									</div>
                                </div>
                            </div>
