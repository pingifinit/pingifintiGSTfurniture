<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
						  <form action="<?php echo base_url();?>index.php/Admin/Edit_Product_Data/<?php echo $tablename; ?>/<?php echo $id; ?>" method="post">
							...
							<div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $product_name;?>" placeholder="Enter Product Name Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Quantity</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" value="<?php echo $quantity; ?>" id="quantity" name="quantity" placeholder="Enter Quantity Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Price Per 1 Product</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" value="<?php echo $price; ?>" id="price" name="price" placeholder="Enter Price Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Total</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" value="<?php echo $total; ?>" id="total" name="total" placeholder="Enter Total Price Here">
									</div>
                                </div>
								<div class="form-group row" style="display:none">
                                    <label class="col-md-3 m-t-15">Purchase Date</label>
                                    <div class="col-sm-9">
										<input type="date" class="form-control" value="<?php echo $purchase_date; ?>" id="purchase_date" name="purchase_date" placeholder="Enter Purchase Date Here">
									</div>
                                </div>
                            </div>
