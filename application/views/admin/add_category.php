            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
						  <div class="card-body">
							<a href="<?php echo base_url(); ?>index.php/Admin/View/list_category"><button type="submit" style="float:right" class="btn btn-info">Manage Category</button></a>
						  </div>
						  <form action="<?php echo base_url();?>index.php/Insert_Category" method="post">
                            <div class="card-body">
