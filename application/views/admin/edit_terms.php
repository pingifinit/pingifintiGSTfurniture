                        ...
                        <div class="card">
						  <div class="border-top">
                                <div class="card-body" style="float:right">
                                    <a href="<?php echo base_url(); ?>index.php/Admin/View/list_terms"><button type="submit" class="btn btn-danger">Manage Terms & Conditins</button></a>
                                </div>
                            </div>
						  <form action="<?php echo base_url();?>index.php/Admin/Edit_Terms_Data/<?php echo $tablename = "terms"; ?>/<?php echo $id; ?>" method="post">
                            <?php $profile = $this->Admin_model->table_column($tablename="terms", $column="id", $val=$id);
								if (count($profile) > 0) 
								{ 
									foreach($profile as $row)
									{ $description = $row['description']; } }?>
							<div class="card-body">
                                <h5 class="card-title">Edit Terms & Conditions</h5>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Description</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" value="<?php echo $description; ?>" id="description" name="description" placeholder="Enter Description Here">
									</div>
                                </div>
                            </div>
                            <div class="border-top">
