                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<a href="<?php echo base_url();?>index.php/Admin/View/list_debit"><button style="width: 119px;margin-left: 85%;margin-top: 20px;" type="button" class="btn btn-secondary">Manage Debit</button></a>
						  <form action="<?php echo base_url();?>index.php/Admin/Insert_Debit_Info" method="post">
                            <div class="card-body">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="pay1" name="pay1" placeholder="Enter Pay 1 Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15 reference">Total</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="total" name="total" placeholder="Enter Total Here">
									</div>
                                </div>
								<div class="form-group row">
