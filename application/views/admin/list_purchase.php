                                        ...
                                        <tbody>
											...
											<tr>
												...
												<td style="display:flex">
													<a href="<?php echo base_url();?>index.php/Admin/View_Purchase/<?php echo $tablename="purchase"; ?>/<?php echo $row['id']; ?>">
														<button  type="button" class="btn btn-info">View</button>
													</a>
													<a href="<?php echo base_url();?>index.php/Admin/Edit_Purchase/<?php echo $tablename="purchase"; ?>/<?php echo $row['id']; ?>">
														<button style="margin-left:10px" type="button" class="btn btn-danger">Edit</button>
													</a>
													<a href="<?php echo base_url();?>index.php/Admin/Delete_Purchase/<?php echo $tablename="purchase"; ?>/<?php echo $row['id']; ?>">
