						  ...
						  <form action="<?php echo base_url();?>index.php/Admin/Edit_Credit_Data/<?php echo $tablename; ?>/<?php echo $id; ?>" method="post">
							...
							<div class="card-body">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="pay" value="<?php echo $rows['pay']; ?>" name="pay" placeholder="Enter Pay Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Paid Total Amount</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="total" value="<?php echo $rows['total']; ?>" name="total" placeholder="Enter Total amount Here">
									</div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-3 m-t-15">Paid Date</label>
                                    <div class="col-sm-9">
										<input type="date" class="form-control" value="<?php echo $rows['date']; ?>" id="date" name="date" placeholder="Enter Total amount Here">
									</div>
                                </div>
									<?php } } ?>
