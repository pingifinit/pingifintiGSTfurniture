                            ...
                            <div class="card-body">
                                <div class="quotation_main">
                                    ...
                                    <div class="table_part">
									  <form action="<?php echo base_url(); ?>index.php/Admin/Add_NonGst_billing_data_new" method="post">
                                        <?php 
										...
										<table class="table_cont">
                                            ...
                                            <tr>
                                                <th colspan="6">
                                                    ...
                                                    <h5 style="padding-left:10px;margin:0px;">Phone :<span> <input style="width: 230px;margin-left: 75px;margin-top: -26px"  class="form-control" type="text" value="" name="gst_num"/> </span></h5>
                                                </th>
                                                <th style="">
                                                <div class="to1">
                                                </th>
											...
											<tr style="display:none">
                                                ...
                                                <td> <input class="form-control" value="<?php echo $row1['net_amount']; ?>" id="net_amount1" type="text" name=""/> </td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">DISCOUNT</td>
                                                <td> <input class="form-control discount" id="discount" type="text" name="discount"/> </td>
                                            </tr>
                                            <tr>
