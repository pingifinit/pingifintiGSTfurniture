                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
						  ...
						  <form action="<?php echo base_url();?>index.php/Admin/Insert_Invoice" method="post">
                            <div class="card-body">
                                <h5 class="card-title">Form Elements</h5>
                                <div class="form-group row">
                                    <label class="col-md-3 m-t-15">Invoice Name</label>
                                    <div class="col-sm-9">
										<input type="text" class="form-control" id="category_name" name="invoice" required placeholder="Enter Invoice Name Here">
									</div>
                                </div>
