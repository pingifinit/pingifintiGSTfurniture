                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="quotation_main">
                                    ...
                                    <?php $profiles = $this->Admin_model->get_id_val($tablename="invoice_add");
										if (count($profiles) > 0) 
										{ 
									...
									<div class="table_part">
                                        <table class="table_cont">
                                            ...
                                            <tr>
												...
												<th colspan="6">
                                                    <div class="to2">
                                                        <h5 style="padding-left:10px;margin-top:20px">INVOICE TO :</h5>
													...
													<h5 style="padding-left:10px;margin:0px;margin-bottom:20px">GSTIN : <span><?php echo $gst_num; ?></span></h5>
														
												</th>
													
                                                <th style="border-left:2px solid black;">
                                                <div class="to1">
                                                <h4 style="margin-bottom:20px">INVOICE NO</h4>
												<span style="margin-left:45px"><?php echo $invoice_num; ?></span>
                                                </div>
                                                </th>
                                                <th style="border-left:2px solid black;">
                                                <div class="to1">
                                            ...
                                            <?php $profile1 = $this->Admin_model->table_column($tablename="invoice_add", $column="invoice_no", $val = $rows['invoice_no']);
												$i = 1;
												if (count($profile1) > 0) 
												{ 
                                    ...
                                    <div class="conclude">
                                            ...
                                            <?php $profile_new = $this->Admin_model->table_column_val($tablename="bank");
												if (count($profile_new) > 0) 
													{ 
														...
														{ ?>
                                            <div class="bank_details col-md-12" style="width: 100%">
                                                <div class="" style="display:flex;width:100%;">
                                                <div class="" style="width:50%;">
                                                    <h6>NAME <span style="margin-left:40px">:</span></h6>
                                                </div>
                                                <div class="" style="width:50%;">
                                                    <p> <input style="height: 24px;" value="<?php echo $row_new['name']; ?>" class="form-control" id="name_bank" type="text" name="name_bank"/> </p>
                                                </div>
                                                </div>
                                                <div class="" style="display:flex;width:100%;">
                                                <div class="" style="width:50%;">
                                                ...
                                                <div class="" style="width:50%;">
                                                    <p> <input style="height: 24px;" class="form-control" id="bank" value="<?php echo $row_new['bank']; ?>" type="text" name="bank"/> </p>
                                                </div>
                                                </div>
                                                <div class="" style="display:flex;width:100%">
                                                <div class="" style="width:50%;">
                                                ...
                                                <div class="" style="width:50%;">
                                                    <p> <input style="height: 24px;" class="form-control" id="bank_ac_no" type="text" value="<?php echo $row_new['ac_num']; ?>" name="bank_ac_no"/> </p>
                                                </div>
                                                </div>
                                                <div class="" style="display:flex;width:100%;">
                                                <div class="" style="width:50%;">
                                                ...
                                                <div class="" style="width:50%;">
                                                    <P> <input style="height: 24px;" class="form-control" value="<?php echo $row_new['ifsc_num']; ?>" id="bank_ifsc" type="text" name="bank_ifsc"/> </P>
                                                </div>
                                                </div>
                                            </div>
													<?php } }  ?>
                                        ...
                                        <div class="footer_base" style="width:100%;">
                                            ...
                                            <div class="base" style="width:100%;height:100%;">
                                                <h6 style="float:right;width:40%;margin-top:50px;">For NEWLOOK WINDOORS</h6>
                                            </div>
