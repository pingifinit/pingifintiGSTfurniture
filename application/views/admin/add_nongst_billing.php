            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Non GST Quotation</h4>
                            ...
                            <div class="card-body">
                                <div class="quotation_main">
                                    ...
                                    <div class="table_part">
									  <form action="<?php echo base_url(); ?>index.php/Admin/Add_NonGst_billing_data" method="post">
                                        <table class="table_cont">
                                            ...
                                            <tr>
                                                <th colspan="6">
                                                    ...
                                                    <h5 style="padding-left:10px;margin:0px;">PHONE :<span> <input style="width: 230px;margin-left: 75px;margin-top: -26px"  class="form-control" type="text" name="gst_num"/> </span></h5>
                                                </th>
                                                <th style="">
                                                ...
                                                <div class="to1">
                                                    <h4>DATE :</h4>
													<input class="form-control" id="date" value="<?php echo date('Y-m-d'); ?>" type="date" name="date"/>
                                                </div>
                                                </th>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="conclude">
                                        ...
                                        <div class="footer_base">
                                            ...
                                            <div class="base">
                                                <h6 style="margin-left:394%;width:100%;margin-top: -102px;">For NEWLOOK WINDOORS</h6>
                                            </div>
                                        </div>
                                    </div>
