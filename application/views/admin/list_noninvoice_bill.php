                                ...
                                <div class="quotation_main">
									...
									<div class="table_part">
                                        <table class="table_cont">
                                            ...
                                            <?php $profile1 = $this->Admin_model->table_column($tablename="invoice_add", $column="invoice_non", $val = $rows['invoice_non']);
												$i = 1;
												if (count($profile1) > 0) 
												{ 
											...
											<tr>
												...
												{ 
													...
													{ $produt_name = $row2['product_name'];} }?>
                                                <td><?php echo $produt_name; ?></td>
