                            ...
                            <div class="card-body">
                                <div class="quotation_main">
                                    ...
                                    <div class="table_part">
									  <form action="<?php echo base_url(); ?>index.php/Admin/Edit_Invoice_data/<?php echo $tablename; ?>/<?php echo $invoice_new; ?>" method="post">
                                        <?php 
											$profile1 = $this->Admin_model->table_column_group_val_whr($tablename="invoice_add", $column="invoice_new", $val=$invoice_new);
												if (count($profile1) > 0) 
												{ 
										...
										<table class="table_cont">
                                            ...
                                            <tr>
                                                <th colspan="6">
                                                    ...
                                                    <h5 style="padding-left:10px;margin:0px;">GSTIN :<span> <input style="width: 230px;margin-left: 75px;margin-top: -26px"  class="form-control" type="text" value="<?php echo $row1['gst_num']; ?>" name="gst_num"/> </span></h5>
                                                </th>
											...
											<?php $profile_new = $this->Admin_model->table_column($tablename="invoice_add", $column="invoice_new", $val=$invoice_new);
                                            ...
                                            <tr>
												...
												<td> 
													 <a href="<?php echo base_url();?>index.php/Admin/Delete_Billing/<?php echo $tablename="invoice_add";?>/<?php echo $row1['invoice_new']; ?>/<?php echo $row_new['id']; ?>/<?php echo $row_new['quantity']; ?>/<?php echo $row_new['product_id']; ?>" class="">
