                            ...
                            <div class="card-body">
                                <div class="quotation_main">
                                    ...
                                    <div class="table_part">
									  <form action="<?php echo base_url(); ?>index.php/Admin/Add_billing_data_new" method="post">
                                        <?php 
											$profile1 = $this->Admin_model->table_column_group_val_whr($tablename="quotation_add", $column="invoice_new", $val=$invoice_new);
												if (count($profile1) > 0) 
												{ 
										...
										<table class="table_cont">
                                            ...
                                            <tr>
                                                <th colspan="6">
													...
													<?php $profile2 = $this->Admin_model->table_column($tablename="customer", $column="id", $val=$row1['customer_id']);
																if (count($profile2) > 0) 
																	{ 
																		foreach($profile2 as $row2)
																	{ $gst_num = $row2['gst_num']; } }?>
                                                    <h5 style="padding-left:10px;margin:0px;">GSTIN :<span> <input style="width: 230px;margin-left: 75px;margin-top: -26px"  class="form-control" type="text" value="<?php echo $gst_num; ?>" name="gst_num"/> </span></h5>
                                                </th>
                                                <th style="border-left:2px solid black;">
                                                <div class="to1">
                                                <h4>INVOICE NO</h4>
												<input class="form-control" id="invoice_no" value="<?php echo $row1['invoice_no']; ?>" type="text" name="invoice_no"/>
												<input style="display:none;" class="form-control" id="" value="<?php echo $row1['invoice_new']; ?>" type="text" name="invoice_new"/>
                                                </div>
                                                </th>
                                                <th style="border-left:2px solid black;">
                                                <div class="to1">
											...
											<?php $profile_new = $this->Admin_model->table_column($tablename="quotation_add", $column="invoice_new", $val=$invoice_new);
                                            ...
                                            <tr>
                                                ...
                                                <td> <input class="form-control cgst" value="<?php echo round($row1['gst']/2, 2); ?>" id="cgst" type="text" name="cgst"/> </td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">SGST 9%</td>
                                                <td> <input class="form-control sgst" value="<?php echo round($row1['gst']/2, 2); ?>" id="sgst" type="text" name="sgst"/> </td>
                                            </tr>
                                            <tr>
